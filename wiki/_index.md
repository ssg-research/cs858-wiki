...
- [All paper pages](papers/_index.md)
- [All concept pages](concepts/_index.md)
- [Change log](log.md)
...
([procedure](../docs/ops/generate-paper-summary.md)): instructor-curated,
AI-drafted, peer-reviewable. Students never author these pages. Links between
pages are plain relative Markdown links so the wiki renders in any Markdown
editor, on GitHub, and in a static-site build.
