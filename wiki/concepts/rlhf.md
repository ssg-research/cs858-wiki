...
- [Representation Engineering: A Top-Down Approach to AI Transparency](../papers/zou-2023-representation-engineering.md) — its chat models are RLHF-trained, the safety behavior whose internal representation the paper reads and edits.
