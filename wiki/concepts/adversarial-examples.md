...
- [SoK: Unintended Interactions among Machine Learning Defenses and Risks](../papers/duddu-2023-unintended-interactions.md) — surveys evasion as one of its security risks and adversarial training as the matched defense, tracking how that defense's effect on overfitting and memorization shifts other risks.
