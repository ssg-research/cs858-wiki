...
controls average-case loss only; it promises nothing about the loss at inputs
an adversary picks near the data, which is the gap that adversarial and robust
training objectives address.
