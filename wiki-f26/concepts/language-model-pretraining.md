...
- [Representation Engineering: A Top-Down Approach to AI Transparency](../papers/zou-2023-representation-engineering.md) — reads and steers high-level concepts in the hidden activations of pretrained transformer language models.
