...
- [Membership Inference Attacks From First Principles](../papers/carlini-2022-lira.md) — names training-time manipulation as what its adversary cannot do, which is what separates its observe-only privacy setting from a poisoning one.
