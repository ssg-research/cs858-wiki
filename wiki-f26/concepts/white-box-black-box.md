...
- [What Makes and Breaks Safety Fine-tuning? A Mechanistic Study](../papers/jain-2024-safety-finetuning.md) — its mechanistic analysis is white-box throughout, reading activations, weights, and gradients at every layer, and its embedding attack assumes white-box access.
